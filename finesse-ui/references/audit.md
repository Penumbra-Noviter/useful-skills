...
**First run the detector** (no network, pure local file scan) to get machine-verifiable hits, then add your own eye. Run from the skill root (the directory containing `scripts/`):
